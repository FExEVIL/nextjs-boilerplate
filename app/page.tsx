...
function StatCard({
  ...
  return (
    <div
      className={`${bg} border-2 border-gray-200 p-6 rounded-sm hover:shadow-lg transition-all cursor-pointer hover:scale-105 duration-200`}
    >
        ...
        >
          ...
          >
            ...
            <div className="space-y-6">
              <div>
                <label htmlFor="email" className="block text-sm font-normal mb-2 text-gray-700">
                  Email Address
                </label>
                <input
                  id="email"
              ...
              <div>
                <label htmlFor="password" className="block text-sm font-normal mb-2 text-gray-700">
                  Password
                </label>
                <input
                  id="password"
            ...
            <p className="mt-6 text-center text-sm text-gray-600">
              Need access?{' '}
              <a href="#contact" className="text-gray-900 hover:text-gray-600 font-normal">
                Contact us
              </a>
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-2xl">
            <p className="text-xl md:text-2xl text-gray-500 font-light leading-relaxed mb-12">
              Building enduring companies that shape the future of finance, technology, and human
              progress.
            </p>
            <a
              href="#contact"
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
            ...
            <div className="space-y-16">
              <div>
                <h3 className="text-lg font-medium mb-3 tracking-wide text-neutral-900">
                  Partnership first
                </h3>
                <p className="text-neutral-600 text-base leading-relaxed font-light">
                  We believe in rolling up our sleeves alongside exceptional founders. Our success
                  is measured by the lasting impact our companies create.
                </p>
              </div>
              <div>
                <h3 className="text-lg font-medium mb-3 tracking-wide text-neutral-900">
                ...
                <p className="text-neutral-600 text-base leading-relaxed font-light">
                  Great companies take time to build. We provide the runway and support needed to
              ...
              <div>
                ...
                <p className="text-neutral-600 text-base leading-relaxed font-light">
                  We make concentrated bets on ideas we deeply believe in, backing founders who are
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
              <div>
                <div className="mb-8">
                  ...
                  <p className="text-gray-600 text-lg leading-relaxed">
                    Reimagining the rails of global finance—from payments and lending to wealth
                    management and institutional services.
                  </p>
                </div>
              </div>
              ...
              <div>
                <div className="mb-8">
                  ...
                  <p className="text-gray-600 text-lg leading-relaxed">
                    Building the tools that power the next generation of business— automation,
                    intelligence, and seamless operations.
                  </p>
                </div>
              </div>
              ...
              <div>
                <div className="mb-8">
                  ...
                  <p className="text-gray-600 text-lg leading-relaxed">
                    Supporting breakthrough innovations in AI, quantum computing, and technologies
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-16">
            <div>
              ...
              <div className="text-black text-sm uppercase tracking-wider">
            ...
            {PORTFOLIO_COMPANIES.map((company, index) => (
              <div key={index} className="group">
                <div className="border border-neutral-200 hover:border-black transition-all duration-500 p-10 h-full hover:shadow-sm cursor-pointer">
                  ...
                  <p className="text-neutral-600 mb-6 leading-relaxed text-sm font-light">
                    {company.description}
                  </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {TEAM_MEMBERS.map((member, index) => (
              <div key={index} className="group">
                ...
                <p className="text-neutral-500 text-xs mb-5 uppercase tracking-widest font-medium">
                  {member.title}
                </p>
                <p className="text-neutral-600 leading-relaxed text-sm font-light">{member.bio}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section id="contact" className="py-32 px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-neutral-500 font-light leading-relaxed mb-16 max-w-3xl mx-auto">
            Building something that could change an industry? We'd love to hear from you.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            <div>
              ...
              <div className="space-y-4">
                <a
                  href="#"
                  className="block text-neutral-300 hover:text-white text-sm transition-colors"
                >
                  Our Ethos
                </a>
                <a
            ...
            <div>
              <h4 className="text-sm font-normal mb-6 uppercase tracking-wider">
                Business Entities
              </h4>
              <div className="space-y-4">
                <a
                  ...
                  className="block text-neutral-300 hover:text-white text-sm transition-colors"
                >
                  Ellington Hart Capital
                </a>
                <a
                  href="#"
                  className="block text-neutral-300 hover:text-white text-sm transition-colors"
                >
                  Ellington Hart Ventures
                </a>
                <a
                  href="#"
                  className="block text-neutral-300 hover:text-white text-sm transition-colors"
                >
                  Ellington Hart Global Equities
                </a>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <a
                  ...
                  className="block text-neutral-300 hover:text-white text-sm transition-colors"
                >
                  Ellington Hart Ampersand Login
                </a>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="text-xs text-neutral-400">© 2025 ELLINGTONHART CAPITAL</div>
            </div>
          </div>
        </div>
      </footer>
...
function OrionLandingPage({ onLogout }: { onLogout: () => void }) {
  ...
  const fetchMarketData = async () => {
    ...
    try {
      ...
      const dowPromise = fetch(
        `https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=DIA&apikey=${ALPHA_VANTAGE_KEY}`
      );
      const nasdaqPromise = fetch(
        `https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=QQQ&apikey=${ALPHA_VANTAGE_KEY}`
      );

      // Batch 2: Indian indices
      const sensexPromise = fetch(
        `https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=SENSEX.BSE&apikey=${ALPHA_VANTAGE_KEY}`
      );
      const niftyPromise = fetch(
        `https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=NIFTY.NSE&apikey=${ALPHA_VANTAGE_KEY}`
      );

      // Batch 3: Top Indian stocks (using NSE symbols)
      const tcsPromise = fetch(
        `https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=TCS.BSE&apikey=${ALPHA_VANTAGE_KEY}`
      );
      const infosysPromise = fetch(
        `https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=INFY.BSE&apikey=${ALPHA_VANTAGE_KEY}`
      );
      const reliancePromise = fetch(
        `https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=RELIANCE.BSE&apikey=${ALPHA_VANTAGE_KEY}`
      );
      const hdfcPromise = fetch(
        `https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=HDFCBANK.BSE&apikey=${ALPHA_VANTAGE_KEY}`
      );
      const wipromise = fetch(
        `https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=WIPRO.BSE&apikey=${ALPHA_VANTAGE_KEY}`
      );

      // Batch 4: Sector performance
      const sectorPromise = fetch(
        `https://www.alphavantage.co/query?function=SECTOR&apikey=${ALPHA_VANTAGE_KEY}`
      );

      // Batch 5: Market news
      const newsPromise = fetch(
        `https://www.alphavantage.co/query?function=NEWS_SENTIMENT&topics=technology,finance,economy&limit=10&apikey=${ALPHA_VANTAGE_KEY}`
      );
    ...
    <div className="min-h-screen bg-white scroll-smooth">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-6">
              <a
                href="#markets"
                className="text-gray-600 hover:text-[#0A1F44] text-sm transition-colors focus:outline-none focus:text-[#0A1F44]"
              >
                Markets
              </a>
              <a
          ...
          {mobileMenuOpen && (
            <div className="md:hidden py-4 border-t border-gray-200">
              <div className="flex flex-col space-y-4">
                <a
                  href="#markets"
                  className="text-gray-600 hover:text-[#0A1F44] text-sm py-2"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  Markets
                </a>
                ...
                <button
                  ...
                  className="text-sm font-medium uppercase border-2 border-[#0A1F44] text-[#0A1F44] px-4 py-3 rounded-sm hover:bg-[#0A1F44] hover:text-white transition-all text-center"
                >
                  Logout
                </button>
              </div>
      ...
      <div className="bg-gradient-to-r from-amber-50 to-orange-50 border-b border-amber-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 py-2">
          <p className="text-xs text-center text-amber-900">
            <strong>Live Market Data Dashboard.</strong> Real-time indices, stocks, sector
            performance & news powered by Alpha Vantage API. Educational purposes only. Not
            investment advice.
          </p>
        </div>
      </div>
      ...
      <section className="pt-12 pb-8 px-4 sm:px-8 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-6 gap-4">
            <div>
              <h1 className="text-4xl md:text-5xl font-extralight mb-2 tracking-tight text-[#0A1F44]">
                Good Morning
              </h1>
              <p className="text-base md:text-lg text-gray-600">
                Your market intelligence briefing is ready
              </p>
            </div>
            <div className="text-left md:text-right">
              <div className="flex items-center gap-2 text-xs uppercase tracking-widest text-black/70 mb-2 flex-wrap">
                ...
                {!isLoading && !error && (
                  <span className="px-2 py-1 bg-emerald-100 text-emerald-800 rounded-full font-medium animate-pulse">
                    Live
                  </span>
                )}
                {isLoading && (
          ...
          {error && (
            <div className="bg-red-50 border-2 border-red-200 rounded-sm p-4 mb-6">
              <p className="text-red-800 text-sm">
                ...
                <button onClick={handleRefresh} className="ml-4 underline hover:no-underline">
                  Retry
                </button>
              </p>
            </div>
          ...
          {!isLoading &&
            !error &&
            (marketData || stockData || sectorData || newsData.length > 0) && (
          ...
          {isLoading ? (
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {[1, 2, 3, 4].map(i => (
                <div
                  key={i}
                  className="bg-gray-100 border-2 border-gray-200 p-6 rounded-sm animate-pulse"
                >
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <StatCard
                ...
                label="Sensex Change"
                color={
                  marketData && marketData.sensex && isPositive(marketData.sensex)
                    ? 'text-emerald-600'
                    : 'text-red-600'
                }
                bg={
          ...
          {isLoading ? (
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {[1, 2, 3, 4].map(i => (
                <div
                  key={i}
                  className="bg-gray-100 border-2 border-gray-200 p-5 rounded-sm animate-pulse"
                >
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {marketData && marketData.sensex ? (
                <IndexCard
                  name="Sensex"
                  value={
                    marketData.sensex['05. price']
                      ? parseFloat(marketData.sensex['05. price']).toLocaleString('en-IN', {
              ...
              {marketData && marketData.nifty ? (
                <IndexCard
                  name="Nifty 50"
                  value={
                    marketData.nifty['05. price']
                      ? parseFloat(marketData.nifty['05. price']).toLocaleString('en-IN', {
                          maximumFractionDigits: 2,
                        })
                      : '25,014.60'
                  }
      ...
      <section className="px-4 sm:px-8 pb-12">
        <div className="max-w-7xl mx-auto">
          ...
          <div
            className={`bg-gradient-to-br ${marketData && marketData.sensex && isPositive(marketData.sensex) ? 'from-emerald-50 to-white border-emerald-200' : 'from-red-50 to-white border-red-200'} border-2 p-12 rounded-sm text-center`}
          >
            <div
              className={`text-6xl font-extralight mb-4 tracking-tight ${marketData && marketData.sensex && isPositive(marketData.sensex) ? 'text-emerald-600' : 'text-red-600'}`}
            >
              {marketData && marketData.sensex
            ...
            <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto">
              <div>
                <div
                  className={`text-3xl font-light mb-2 ${actualGainers.length > actualLosers.length ? 'text-emerald-600' : 'text-red-600'}`}
                >
      ...
      <section className="px-4 sm:px-8 pb-12">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-extralight mb-6 tracking-tight text-[#0A1F44]">
            ...
            {sectorData && <span className="text-emerald-600 text-sm">(Real-time)</span>}
          </h2>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-sm overflow-x-auto">
              <table className="w-full">
                <thead className="border-b-2 border-gray-200 bg-gray-50">
                  <tr>
                    <th className="text-left p-4 text-xs uppercase tracking-widest text-black font-medium">
                      Sector
                    </th>
                    <th className="text-right p-4 text-xs uppercase tracking-widest text-black font-medium">
                      Real-Time
                    </th>
                    <th className="text-right p-4 text-xs uppercase tracking-widest text-black font-medium">
                      1 Day
                ...
                <tbody>
                  {Object.entries(sectorData['Rank A: Real-Time Performance'])
                    .slice(0, 6)
                    .map(([sector, data]: [string, any], i) => {
                      const rtChange = parseFloat(data);
                      const oneDayChange = sectorData['Rank B: 1 Day Performance']?.[sector]
                        ? parseFloat(sectorData['Rank B: 1 Day Performance'][sector])
                        : 0;
                      const fiveDayChange = sectorData['Rank C: 5 Day Performance']?.[sector]
                        ? parseFloat(sectorData['Rank C: 5 Day Performance'][sector])
                        : 0;
                      const oneMonthChange = sectorData['Rank D: 1 Month Performance']?.[sector]
                        ? parseFloat(sectorData['Rank D: 1 Month Performance'][sector])
                        : 0;
                      ...
                      return (
                        ...
                        >
                          ...
                          <td
                            className={`p-4 text-right font-medium ${rtChange >= 0 ? 'text-emerald-600' : 'text-red-600'}`}
                          >
                            {formatSectorChange(data)}
                          </td>
                          <td
                            className={`p-4 text-right ${oneDayChange >= 0 ? 'text-emerald-600' : 'text-red-600'}`}
                          >
                            {formatSectorChange(sectorData['Rank B: 1 Day Performance'][sector])}
                          </td>
                          <td
                            className={`p-4 text-right ${fiveDayChange >= 0 ? 'text-emerald-600' : 'text-red-600'}`}
                          >
                            {formatSectorChange(sectorData['Rank C: 5 Day Performance'][sector])}
                          </td>
                          <td
                            className={`p-4 text-right ${oneMonthChange >= 0 ? 'text-emerald-600' : 'text-red-600'}`}
                          >
                ...
                <tbody>
                  {[
                    ...
                    >
                      ...
                      <td
                        className={`p-4 text-right ${row.positive ? 'text-emerald-600' : 'text-red-600'}`}
                      >
                        {row.change}
                      </td>
                      <td
                        className={`p-4 text-right font-medium ${row.positive ? 'text-emerald-600' : 'text-red-600'}`}
                      >
                        {row.percent}
                      </td>
                    </tr>
          ...
          {sectorData && (
            <div className="mt-4 text-xs text-gray-500">
              <span>
                US sector data updated: {sectorData.Metadata?.['Last Refreshed'] || 'Real-time'}
              </span>
            </div>
          )}
        </div>
        ...
        <div className="max-w-7xl mx-auto py-12">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
            <h2 className="text-3xl font-extralight tracking-tight text-[#0A1F44]">
              Top Performers{' '}
              {stockData && <span className="text-emerald-600 text-sm">(Live Data)</span>}
            </h2>
          ...
          {isLoading ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[1, 2].map(i => (
                <div
                  key={i}
                  className="bg-gray-100 border-2 border-gray-200 rounded-sm p-6 animate-pulse"
                >
                ...
                actualGainers.filter(
                  ...
                  <div className="bg-white border-2 border-gray-200 rounded-sm p-6">
                    <h3 className="text-xs uppercase tracking-widest text-black mb-6 font-medium flex items-center gap-2">
                      ...
                      Top Gainers{' '}
                      {stockData && <span className="text-emerald-600">(Real-time)</span>}
                    </h3>
                    <div className="space-y-4">
                      {actualGainers
                        .filter(
              ...
              <tbody>
                {[
                  ...
                  >
                    ...
                    <td className="p-4">
                      <span
                        className={`inline-block px-3 py-1 rounded-sm text-xs font-semibold uppercase ${row.badge}`}
                      >
                        {row.activity}
                      </span>
                    </td>
            ...
            <table className="w-full">
              <thead className="border-b-2 border-gray-200 bg-gray-50">
                <tr>
                  ...
                  <th className="text-center p-4 text-xs uppercase tracking-widest text-black font-medium">
                    Buy/Sell
                  </th>
                  <th className="text-right p-4 text-xs uppercase tracking-widest text-black font-medium">
                    Quantity (Mn)
              ...
              <tbody>
                {[
                  ...
                  >
                    ...
                    <td
                      className={`p-4 text-center font-semibold ${row.buy ? 'text-emerald-600' : 'text-red-600'}`}
                    >
                      {row.type}
                    </td>
      ...
      <section id="news" className="px-4 sm:px-8 pb-12 bg-gray-50">
        <div className="max-w-7xl mx-auto py-12">
          <h2 className="text-3xl font-extralight mb-6 tracking-tight text-[#0A1F44]">
            Market News{' '}
            {newsData.length > 0 && <span className="text-emerald-600 text-sm">(Live Feed)</span>}
          </h2>
          ...
          {isLoading ? (
            ...
            <div className="space-y-3">
              {newsData.slice(0, 6).map((news, i) => {
                const sentiment =
                  news.overall_sentiment_score >= 0.15
                    ? 'positive'
                    : news.overall_sentiment_score <= -0.15
                      ? 'negative'
                      : 'neutral';
                const sentimentColor =
                  sentiment === 'positive' ? 'emerald' : sentiment === 'negative' ? 'red' : 'blue';
                ...
                return (
                  ...
                  >
                    <div className="flex justify-between items-start gap-4 mb-2">
                      <h3 className="text-base font-semibold text-[#0A1F44] flex-1">
                        {news.title}
                      </h3>
                      <span
            ...
            <div className="space-y-3">
              {[
                ...
                {
                  title: 'Asian markets rally on positive China manufacturing data',
                  time: '4 hours ago',
                  source: 'Bloomberg',
                },
                {
                  title: 'Oil prices surge 2.5% on Middle East supply concerns',
                  time: '5 hours ago',
                  source: 'CNBC',
                },
                {
                  title: 'IT Sector: Major cloud contracts boost revenue outlook for top firms',
                  time: '3 hours ago',
                  source: 'Economic Times',
                },
                {
                  title: 'Banking: NPA ratios decline to decade-low levels across PSU banks',
                  time: '5 hours ago',
                  source: 'Business Standard',
                },
                {
                  title: 'Auto: EV sales surge 45% YoY, traditional vehicles see modest growth',
                  time: '6 hours ago',
                  source: 'Moneycontrol',
                },
              ].map((news, i) => (
                <div
                  key={i}
                  className={`bg-white border-2 border-gray-200 border-l-4 ${i < 3 ? 'border-l-[#0A1F44]' : 'border-l-emerald-600'} p-5 rounded-sm hover:shadow-lg transition-all`}
                >
          ...
          {newsData.length > 0 && (
            <div className="mt-4 text-xs text-gray-500 text-center">
              <span>
                News powered by Alpha Vantage News & Sentiment API • Sentiment analysis included
              </span>
            </div>
          )}
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white border-2 border-gray-200 rounded-sm p-6 hover:shadow-lg transition-all">
              <h3 className="text-xs uppercase tracking-widest text-black mb-6 font-medium">
                This Week
              </h3>
              <div className="space-y-6">
                {[
        ...
        <div className="max-w-7xl mx-auto py-8">
          <div className="bg-white border-2 border-gray-200 rounded-sm p-6">
            ...
            <div className="text-xs text-gray-600 space-y-2">
              <p>
                <strong>Live Market Data:</strong> Global and Indian indices, individual stocks
                (TCS, Infosys, Reliance, HDFC Bank, Wipro), US sector performance, and market news
                powered by Alpha Vantage API. Data updates every 15 minutes. Free tier may have
                15-20 minute delays for certain markets.
              </p>
              <p>
              ...
              <ul className="list-disc list-inside ml-4 space-y-1">
                ...
                <li>
                  Top Stocks: TCS, Infosys, Reliance, HDFC Bank, Wipro with real-time prices and
                  changes
                </li>
                <li>
                  US Sector Performance: Real-time, 1-day, 5-day, and 1-month performance metrics
                </li>
                <li>Market News: Live feed with sentiment analysis (positive/negative/neutral)</li>
              </ul>
              <p>
                <strong>Illustrative Data:</strong> Bank Nifty, derivatives, bulk deals, delivery
                spikes are for educational demonstration purposes. For real-time trading, please use
                official exchange platforms.
              </p>
              <p>
                <strong>Disclaimer:</strong> This dashboard is for informational purposes only and
                does not constitute investment advice. Always consult with a qualified financial
                advisor before making investment decisions.
              </p>
              <p className="text-emerald-600">
                <strong>API Status:</strong>{' '}
                {isLoading ? 'Fetching data...' : error ? 'Connection error' : 'Connected ✓'} • Last
                refresh:{' '}
      ...
      <footer className="bg-gradient-to-r from-[#0A1F44] to-[#1E293B] text-white py-16 px-4 sm:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12 mb-12">
            <div>
              <h4 className="text-sm font-medium mb-6 uppercase tracking-wider text-emerald-300">
                Company
              </h4>
